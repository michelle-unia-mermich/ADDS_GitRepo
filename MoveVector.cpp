//version of class Move when using Vector and not Array (could not work)
#include <iostream>
#include "Move.h"
#include <algorithm>
...
//!however cannot put this line in the header file since inclusion of too many .h files will redefine this data member too many times. need to include in .cpp file
