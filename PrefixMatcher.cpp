...
TrieNode* PrefixMatcher::tryGetToAWord(std::string prefix, std::string& travelledUntil, std::vector<std::string>& parentWork)
{
...
void PrefixMatcher::insert(std::string word) 
{
...
void PrefixMatcher::searchAllWordsBelowAPrefix(TrieNode* node, std::string prefix, std::vector<std::string>&results)
{
...
void PrefixMatcher::searchAllWordsForPrefix(std::string prefix,std::vector<std::string>&results )
{
...
std::string PrefixMatcher::findLongestPrefixMatchingString(std::string word)
{
    /*
...
void PrefixMatcher::insert(std::string address, int routerNumber) // add a router address
{
    insert(address);
